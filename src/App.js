      ...
      <header class="text-white body-font">
        <div class="bg-[#C2C2C2] container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <div class="mr-5 hover:text-gray-600">Fear & Greed Index</div>
            <a class="mr-5 hover:text-gray-600">Overview Chart</a>
            <a class="mr-5 hover:text-gray-600">Search</a>
          </nav>
        </div>
      </header>
      ...
      <footer class="text-white body-font">
        <div class="bg-[#C2C2C2] container px-5 py-6 mx-auto ">
          <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
            <span class="mt-1 ml-3 text-2xl">Donggul - Donggul</span>
          </a>
          <div className="container mx-auto pt-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-white text-sm mt-5 text-center sm:text-left">
              © {currentYear} 동글동글
            </p>
            <span className="sm:ml-auto sm:mt-5 mt-8 sm:w-auto w-full sm:text-left text-center text-white text-sm">
